...
export default function HowItWorks() {
  ...
  return (
    <>
      <Navbar />
      <section className="relative overflow-hidden bg-slate-50 py-20 text-[#211c58]">
<div className="absolute inset-0 pointer-events-none">
  ...
  />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          >
            <h2 className="mt-4 text-5xl font-bold md:text-6xl text-[#211c58]">
              One Platform.
              <span className="block text-[#4b35a4]">
                Three Powerful Journeys.
              </span>
            </h2>

            <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-800">
  ...
  key={card.title}
  whileHover={{ y: -8 }}
  className="rounded-3xl border border-white/40 p-8"
  style={{
    background: "rgba(255, 255, 255, 0.35)",
    backdropFilter: "blur(16px)",
    WebkitBackdropFilter: "blur(16px)",
    boxShadow: "0 8px 32px rgba(75, 53, 164, 0.12), inset 0 1px 0 rgba(255,255,255,0.6)",
  }}
>
                  <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-button-gradient text-white shadow-lg shadow-[#4b35a4]/30">
                    <Icon size={28} />
                  </div>
                  <h3 className="mb-3 text-xl font-bold text-[#211c58]">{card.title}</h3>
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 rounded-full px-6 py-3 font-semibold transition-all duration-300 ${
                    activeTab === key
                      ? "bg-brand-button-gradient text-white shadow-[0_4px_20px_rgba(75,53,164,0.4)]"
                      : "border border-[#4b35a4]/25 bg-white text-[#4b35a4] hover:border-[#4b35a4]/50"
                  }`}
                >
                  <Icon size={18} />
                  {tab.label}
            ...
            >
              <div className="absolute left-1/2 top-0 hidden h-full w-1 -translate-x-1/2 md:block">
                <motion.div
                  ...
                  className="h-full w-full rounded-full bg-gradient-to-b from-[#4b35a4] via-[#6b52c8] to-[#211c58]"
                />
              </div>
  ...
  className="group relative overflow-hidden rounded-3xl border border-white/40 p-8"
  style={{
    background: "rgba(255, 255, 255, 0.35)",
    backdropFilter: "blur(16px)",
    WebkitBackdropFilter: "blur(16px)",
...
>
                          <div className="absolute inset-0 bg-gradient-to-r from-[#4b35a4]/8 to-[#6b52c8]/5 opacity-0 transition duration-500 group-hover:opacity-100" />

                          <div className="relative z-10">
                            <div className="mb-5 flex items-center gap-4">
                              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#4b35a4] text-white shadow-lg shadow-[#4b35a4]/30">
                                <Icon size={28} />
                              </div>
                            </div>
                            <h3 className="mb-3 text-2xl font-bold text-[#211c58]">
                              {step.title}
                            </h3>
                      ...
                      <div className="relative hidden w-2/12 justify-center md:flex">
                        <motion.div
                          ...
                          className="relative"
                        >
                          <div className="absolute inset-0 animate-pulse rounded-full bg-brand-button-gradient opacity-30 blur-xl" />
                          <div className="relative flex h-16 w-16 items-center justify-center rounded-full border-[6px] border-slate-50 bg-brand-button-gradient text-white text-lg font-bold shadow-[0_0_35px_rgba(75,53,164,0.5)]">
                            {index + 1}
                          </div>
                        </motion.div>
                      </div>
                ...
                >
                  <div className="mx-auto max-w-3xl">
                    <div
  className="relative overflow-hidden rounded-[32px] border border-white/40 p-10 text-center"
  style={{
    background: "rgba(255, 255, 255, 0.35)",
    backdropFilter: "blur(16px)",
    WebkitBackdropFilter: "blur(16px)",
    boxShadow: "0 20px 60px rgba(75,53,164,0.15), inset 0 1px 0 rgba(255,255,255,0.6)",
  }}
>
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(75,53,164,0.1),transparent_70%)]" />
                      ...
                      >
                        <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-3xl bg-brand-button-gradient text-white shadow-lg shadow-[#4b35a4]/30">
                          <CompletionIcon size={38} />
                        </div>
                        <h3 className="mb-4 text-3xl font-bold text-[#211c58] md:text-4xl">
